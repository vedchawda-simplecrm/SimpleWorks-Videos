...
export const ClaudeLogo: React.FC<{ width?: number; rotation?: number }> = ({
  width = 420,
  rotation = 0,
}) => {
  return (
    <svg
      ...
      width={width}
      height={(width * 148.17999) / 689.97997}
      xmlns="http://www.w3.org/2000/svg"
    >
      <g transform="translate(-75.96,-223.53)">
        <path
        ...
        />
        <path d={WORDMARK_PATH} fill="#0f0f0d" />
      </g>
    </svg>
  );
};
